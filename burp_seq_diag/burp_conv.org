...
* Converting Burp Capture file to a Sequence Diagram
...
/Note: while Github supports org files, I don't believe it will execute the Org-Babel 
source blocks so the sequence diagram probably won't be displayed in the Github rendering/
